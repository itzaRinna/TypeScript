// arrays
let names = ['luigi', 'mario', 'yoshi'] // declare and assign an array
...
let mixed = ['ken', 4, 'chun-li', 8, 9]; // array that contains two types
...
// objects
let ninja = { // declare and assign an object
    name: 'mario',
    belt: 'black',
    age: 30
};
